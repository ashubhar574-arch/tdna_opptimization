...
# MAGIC %run "/Workspace/main/common_utilities/CONFIG_MANAGER"

# COMMAND ----------

# MAGIC %run "/Workspace/main/flighthub/turnaround_info/notebooks/avtura_config_nb"

# COMMAND ----------

# MAGIC %run "/Workspace/main/flighthub/turnaround_info/notebooks/avtura_schema_nb"

# COMMAND ----------

# MAGIC %run "/Workspace/main/flighthub/turnaround_info/notebooks/avtura_data_processing_nb"
